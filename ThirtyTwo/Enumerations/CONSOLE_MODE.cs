...
namespace ThirtyTwo.Kernel32.Enumerations
{
    ...
    public enum CONSOLE_MODE : uint
    {
        ...
        /// be used to read "MOUSE_EVENT" input records from the input buffer.
        /// </summary>
        ...
        /// buffer. If the "ENABLE_LINE_INPUT" mode is also enabled, backspace, carriage return,
        ...
        /// mode, use "ENABLE_QUICK_EDIT_MODE | ENABLE_EXTENDED_FLAGS". To disable this mode,
        /// use "ENABLE_EXTENDED_FLAGS" without this flag.
        /// </summary>
        ...
        /// or when "ENABLE_VIRTUAL_TERMINAL_PROCESSING" is set.
        /// </summary>
        ...
        /// Normally when "ENABLE_WRAP_AT_EOL_OUTPUT" is set and text reaches the end of the
        ...
        /// remain above this character as if "ENABLE_WRAP_AT_EOL_OUTPUT" was off, but the next
        /// printable character will be printed as if "ENABLE_WRAP_AT_EOL_OUTPUT" is on. No
        ...
        /// in conjunction with setting "ENABLE_VIRTUAL_TERMINAL_PROCESSING" to better emulate
        ...
        /// accident. Note that using the "ENABLE_VIRTUAL_TERMINAL_PROCESSING" mode can result

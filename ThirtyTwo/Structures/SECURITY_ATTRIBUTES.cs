...
namespace ThirtyTwo.Kernel32.Structures
{
    ...
    public struct SECURITY_ATTRIBUTES : IEquatable<SECURITY_ATTRIBUTES>
    {
        ...
        /// </summary>
        public static uint nLength = (uint)Marshal.SizeOf(typeof(SECURITY_ATTRIBUTES));
        ...
        public static bool operator ==(
            SECURITY_ATTRIBUTES firstStructure,
            SECURITY_ATTRIBUTES secondStructure
        )
        {
        ...
        {
            if (obj is SECURITY_ATTRIBUTES aTTRIBUTES)
            {

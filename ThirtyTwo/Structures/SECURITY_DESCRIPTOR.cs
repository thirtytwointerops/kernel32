...
namespace ThirtyTwo.Kernel32.Structures
{
    ...
    public struct SECURITY_DESCRIPTOR : IEquatable<SECURITY_DESCRIPTOR>
    {
        ...
        public static bool operator ==(
            SECURITY_DESCRIPTOR firstStructure,
            SECURITY_DESCRIPTOR secondStructure
        )
        {
        ...
        /// <inheritdoc />
        public bool Equals(SECURITY_DESCRIPTOR other)
        {
            return this == other;
        }
        ...
        {
            if (obj is SECURITY_DESCRIPTOR dESCRIPTOR)
            {

...
namespace ThirtyTwo.Kernel32.Structures
{
    ...
    public struct CONSOLE_READCONSOLE_CONTROL : IEquatable<CONSOLE_READCONSOLE_CONTROL>
    {
        ...
        /// </summary>
        public static uint nLength = (uint)Marshal.SizeOf(typeof(CONSOLE_READCONSOLE_CONTROL));
        ...
        /// </summary>
        public CTRL_KEY_STATE dwCtrlKeyState;
        ...
        public static bool operator ==(
            CONSOLE_READCONSOLE_CONTROL firstStructure,
            CONSOLE_READCONSOLE_CONTROL secondStructure
        ) {
        ...
        /// <inheritdoc />
        public bool Equals(CONSOLE_READCONSOLE_CONTROL other)
        {
            return this == other;
        }
        ...
        {
            if (obj is CONSOLE_READCONSOLE_CONTROL cONTROL)
            {
                return this == cONTROL;
            }

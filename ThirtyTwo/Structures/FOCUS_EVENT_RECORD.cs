...
namespace ThirtyTwo.Kernel32.Structures
{
    ...
    public struct FOCUS_EVENT_RECORD : IEquatable<FOCUS_EVENT_RECORD>
    {
        ...
        public static bool operator ==(
            FOCUS_EVENT_RECORD firstStructure,
            FOCUS_EVENT_RECORD secondStructure
        )
        {
            ...
            return
                firstStructure.bSetFocus == secondStructure.bSetFocus
            ;
        }
        ...
        /// <inheritdoc />
        public bool Equals(FOCUS_EVENT_RECORD other)
        {
            return this == other;
        }
        ...
        {
            if (obj is FOCUS_EVENT_RECORD rECORD)
            {
                return this == rECORD;
            }

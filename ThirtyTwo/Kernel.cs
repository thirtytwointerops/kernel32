...
namespace ThirtyTwo.Kernel32
{
  ...
  public static class Kernel
  {
    ...
    /// "PseudoConsoleCreationOption" enumeration.
    /// </param>
    /// 
    /// <param name="phPC">
    ...
    /// 
    /// <returns>
    /// If this method succeeds, it returns "Ok". Otherwise, it returns an "ResultHandle"
    /// error code.
    /// </returns>
    [DllImport(
      DLL_NAME,
    ...
    /// The access to the console screen buffer. This parameter can be defined by one of
    /// the values ​​of the "AccessRights" enumeration.
    /// </param>
    /// 
    /// <param name="dwShareMode">
    /// This parameter can be zero, indicating that the buffer cannot be shared, or it can
    /// be one or more values ​​from the "ShareMode" enumeration.
    /// </param>
    /// 
    /// <param name="lpSecurityAttributes">
    /// A pointer to a "SecurityAttributes" structure that determines whether the returned
    ...
    /// A handle to the console screen buffer. The handle must have the "GenericWrite"
    /// access right.
    /// </param>
    /// 
    /// <param name="wAttribute">
    /// The attributes to use when writing to the console screen buffer. This parameter can
    /// be zero or a combination of values ​​from the "CharacterAttributes" enumeration.
    /// </param>
    /// 
    /// <param name="nLength">
    ...
    /// A "Coordinate" structure that specifies the character coordinates of the first cell
    ...
    /// A handle to the console input buffer. The handle must have the "GenericWrite"
    /// access right.
    /// </param>
    /// 
    /// <returns>
    ...
    /// values ​​in the "ControlEvent" enumeration.
    /// </param>
    /// 
    ...
    /// 
    /// <param name="hConsoleOutput">
    /// A handle to the console screen buffer. The handle must have the "GenericRead"
    /// access right.
    /// </param>
    /// 
    /// <param name="lpConsoleCursorInfo">
    /// A pointer to a "ConsoleCursorInformation" structure that receives information about the
    /// console's cursor.
    /// </param>
    /// 
    /// <returns>
    ...
    /// the "ConsoleDisplayMode" enumeration.
    /// </param>
    /// 
    /// <returns>
    /// If the function succeeds, the return value is nonzero. If the function fails, the
    ...
    /// 
    /// <returns>
    /// If the function succeeds, the return value is a "Coordinate" structure that contains the
    ...
    /// A pointer to a "ConsoleHistoryInformation" structure that receives the history settings
    ...
    /// have the "GenericRead" access right.
    /// </param>
    /// 
    /// <param name="lpMode">
    ...
    /// values ​​from the "ConsoleMode" enumeration. When a console is created, all input
    /// modes except "EnableWindowInput" and "EnableVirtualTerminalInput" are enabled
    /// by default. If the "hConsoleHandle" parameter is a screen buffer handle, the mode
    /// can be one or more values ​​from the "ConsoleMode" enumeration. When a screen buffer
    ...
    /// A pointer to a "ConsoleScreenBufferInformation" structure that receives the console
    ...
    /// A "ConsoleScreenBufferInformationExtended" structure that receives the requested
    ...
    /// A pointer to a "ConsoleSelectionInformation" structure that receives the
    ...
    /// A pointer to a "ConsoleFontInformation" structure that receives the requested font
    /// information.
    /// </param>
    /// 
    /// <returns>
    ...
    /// A pointer to a "ConsoleFontInformationExtended" structure that receives the requested
    /// font information.
    /// </param>
    /// 
    /// <returns>
    ...
    /// 
    /// <returns>
    /// If the function succeeds, the return value is a "Coordinate" structure that specifies
    /// the number of character cell columns ("X" member) and rows ("Y" member) in the largest
    ...
    /// 
    /// <param name="hConsoleInput">
    /// A handle to the console input buffer. The handle must have the "GenericRead"
    /// access right.
    /// </param>
    /// 
    ...
    /// "ConsoleStandardDevice" enumeration.
    /// </param>
    /// 
    /// <returns>
    ...
    /// "GenericRead" and "GenericWrite" access rights, unless the application has used
    ...
    /// by one of the values ​​in the "ControlEvent" enumeration.
    /// </param>
    /// 
    /// <returns>
    ...
    /// 
    /// <param name="lpBuffer">
    /// A pointer to an array of "InputRecord" structures that receives the input
    /// buffer data.
    /// </param>
    /// 
    /// <param name="nLength">
    ...
    /// A pointer to a "ReadConsoleControl" structure that specifies a control
    ...
    /// "CharacterInformation" structures whose size is specified by the "dwBufferSize"
    /// parameter.
    /// </param>
    /// 
    /// <param name="dwBufferSize">
    /// The size of the "lpBuffer" parameter, in character cells. The "X" member of the
    /// "Coordinate" structure is the number of columns; the "Y" member is the number of rows.
    /// </param>
    /// 
    /// <param name="dwBufferCoord">
    /// The coordinates of the upper-left cell in the lpBuffer parameter that receives the
    /// data read from the console screen buffer. The "X" member of the "Coordinate" structure
    /// is the column, and the "Y" member is the row.
    /// </param>
    /// 
    /// <param name="lpReadRegion">
    /// A pointer to a "SmallRectangle" structure. On input, the structure members specify the
    ...
    /// in characters. The "X" member of the "Coordinate" structure is the column, and the "Y"
    /// member is the row.
    /// </param>
    /// 
    ...
    /// A pointer to a "SmallRectangle" structure whose members specify the upper-left and
    ...
    /// A "Coordinate" structure that specifies the upper-left corner of the new location of
    /// the "lpScrollRectangle" contents, in characters.
    /// </param>
    /// 
    /// <param name="lpFill">
    /// A pointer to a "CharacterInformation" structure that specifies the character and color
    ...
    /// 
    /// <param name="lpConsoleCursorInfo">
    /// A pointer to a "ConsoleCursorInformation" structure that provides the new specifications
    ...
    /// A "Coordinate" structure that specifies the new cursor position, in characters. The
    ...
    /// values ​​from the "ConsoleDisplayMode" enumeration.
    /// </param>
    /// 
    /// <param name="lpNewScreenBufferDimensions">
    /// A pointer to a "Coordinate" structure that receives the new dimensions of the screen
    ...
    /// 
    /// <param name="lpConsoleHistoryInfo">
    /// A pointer to a "ConsoleHistoryInformation" structure that contains the history settings
    ...
    /// handle, the mode can be one or more of the values ​​in the "ConsoleMode" enumeration.
    /// When a console is created, all input modes except "EnableWindowInput" and
    /// "EnableVirtualTerminalInput" are enabled by default. If the "hConsoleHandle"
    /// parameter is a screen buffer handle, the mode can be one or more of the values ​​in
    /// the "ConsoleMode" enumeration. When a screen buffer is created, both output modes
    ...
    /// 
    /// <param name="lpConsoleScreenBufferInfoEx">
    /// A "ConsoleScreenBufferInformationExtended" structure that contains the console screen
    /// buffer information.
    /// </param>
    /// 
    /// <returns>
    ...
    /// 
    /// <param name="dwSize">
    /// A "Coordinate" structure that specifies the new size of the console screen buffer, in
    ...
    /// A pointer to a "SmallRectangle" structure that specifies the new upper-left and
    ...
    /// 
    /// <param name="lpConsoleCurrentFontEx">
    /// A pointer to a "ConsoleFontInformationExtended" structure that contains the font
    /// information.
    /// </param>
    /// 
    /// <returns>
    ...
    /// one of the values ​​in the "ConsoleStandardDevice" enumeration.
    /// </param>
    /// 
    /// <param name="hHandle">
    ...
    /// 
    /// <param name="lpBuffer">
    /// A pointer to an array of "InputRecord" structures that contain data to be written
    /// to the input buffer.
    /// </param>
    /// 
    /// <param name="nLength">
    ...
    /// origin of a two-dimensional array of "CharacterInformation" structures whose size is specified
    /// by the "dwBufferSize" parameter.
    /// </param>
    /// 
    /// <param name="dwBufferSize">
    /// The size of the buffer pointed to by the "lpBuffer" parameter, in character cells.
    /// The "X" member of the "Coordinate" structure is the number of columns; the "Y" member
    /// is the number of rows.
    /// </param>
    /// 
    /// <param name="dwBufferCoord">
    /// The coordinates of the upper-left cell in the buffer pointed to by the "lpBuffer"
    /// parameter. The "X" member of the "Coordinate" structure is the column, and the "Y"
    /// member is the row.
    /// </param>
    /// 
    ...
    /// can be zero or a combination of values ​​from the "CharacterAttributes" enumeration.
    /// </param>
    /// 
    /// <param name="Length">
    ...
    /// 
    /// <param name="dwWriteCoord">
    /// A "Coordinate" structure that specifies the character coordinates of the first cell in
